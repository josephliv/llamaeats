                    ...
                    <div class="col-md-4">
                        <div class="card card-user">
                            ...
                            <div class="card-body">
                                <div class="author">
                                    <a href="#">
                                        <img class="avatar border-gray" src="<?php echo e(asset('light-bootstrap/img/default-avatar.png')); ?>" alt="...">
...
<?php echo $__env->make('layouts.app', ['activePage' => 'user', 'title' => 'Cruiser Travels Leadbox Management System', 'navName' => 'User Profile', 'activeButton' => 'laravel'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/llamaeats/llama-eats-2/resources/views/profile/edit.blade.php ENDPATH**/ ?>