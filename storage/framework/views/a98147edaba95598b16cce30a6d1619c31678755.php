<?php $__env->startSection('content'); ?>
    <div class="full-page section-image" data-color="black" data-image="<?php echo e(asset('light-bootstrap/img/background.png')); ?>">
        <div class="content">
            <div class="container">
...
<?php echo $__env->make('layouts/app', ['activePage' => 'welcome', 'title' => 'Leadbox Management System'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/llamaeats/llama-eats-2/resources/views/welcome.blade.php ENDPATH**/ ?>