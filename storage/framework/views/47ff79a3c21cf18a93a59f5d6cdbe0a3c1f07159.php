      ...
      <div class="col-12 col-md-4">
        <div class="card text-center" style="box-shadow: 0 0 5px #555;">
          <ul class="list-group list-group-flush">
            ...
            <li class="list-group-item">Emails Received: <span id="emails-sent"><?php echo e($leadMails['total24h']); ?></span></li>
            <li class="list-group-item">Emails Sent: <span id="emails-sent"><?php echo e($leadMails['totalSent24h']); ?></span></li>
            <li class="list-group-item">Emails rejected: <span id="emails-sent"><?php echo e($leadMails['totalReject24h']); ?></span></li>
        ...
        <div class="col-12 col-md-4">
          <div class="card text-center" style="box-shadow: 0 0 5px #555;">
              ...
              <small>This shows the total stats.</small>
                ...
                <li class="list-group-item">Emails Received: <span id="emails-sent"><?php echo e($leadMails['total']); ?></span></li>
                <li class="list-group-item">Emails Sent: <span id="emails-sent"><?php echo e($leadMails['totalSent']); ?></span></li>
                <li class="list-group-item">Emails rejected: <span id="emails-sent"><?php echo e($leadMails['totalReject']); ?></span></li>
              </ul>
            </div>
        </div>
    </div>
                    ...
                    <div class="card strpied-tabled-with-hover" style="box-shadow: 0 0 5px #555;">
                        <div class="card-header  text-center">
                            ...
                            <div class="p-4">
                                ...
                                <input type="date" id="from-date" name="from-date" value="<?php echo e(explode(' ', \Carbon\Carbon::now())[0]); ?>" > to <input type="date" id="to-date" name="to-date" value="<?php echo e(explode(' ', \Carbon\Carbon::now())[0]); ?>" >
...
<?php echo $__env->make('layouts.app', ['activePage' => 'dashboard', 'title' => 'Leadbox Management System', 'navName' => 'Dashboard', 'activeButton' => 'laravel'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/llamaeats/llama-eats-2/resources/views/dashboardadmin.blade.php ENDPATH**/ ?>